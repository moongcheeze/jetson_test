...
<p>
본 레포지토리는 Jetson Orin Nano 보드를 이용해 쿠버네티스 클러스터를 구성하는 과정을 설명합니다.
</p>
<p>
이후 노드 간 컨테이너 이미지 공유를 위한 Local Registry 구축과 실행 결과 저장을 위한 NFS(Network File System) 설정 과정을 정리합니다.
</p>
<p>
